  ...
  <div class="main">
    ...
    <div class="main-right">
          ...
          <div class="user-title">正尚科技后台管理平台</div>
              ...
              <el-table-column prop="text" label="轮播图文字"> </el-table-column>
							<el-table-column prop="sort" label="排序数值"> </el-table-column>
...
<script type='ecmascript-6'>
  ...
  import addOurService from './slideshow/addOurService';
  import changeOurService from './slideshow/changeOurService';
  import user from './user.vue';
    ...
    mounted (){
      ...
      _this.$get('/official-website/background-slideshow/queryByPage',pageData).then(data=>{
    ...
    methods: {
      deleteFun(row){
        ...
        _this.$confirm('是否要删除', '是否继续?', '提示', {
          ...
          type: 'warning'
        	...
        	_this.$get('/official-website/background-slideshow/delete',{id:row.id}).then(data=>{
        		var seller=JSON.stringify(data);
        		_this.$message({
        			type: 'success',
        			message: data+'!'
      ...
      changeSwitch (row) {
        ...
        var _this=this;
          ...
          type: 'warning'
					...
					_this.$get('/official-website/background-slideshow/updateUse',dataStr).then(data=>{
						var seller=JSON.stringify(data);
						//console.log('结果:'+seller);
      ...
      pageAxios(page){
        ...
        _this.$get('/official-website/background-slideshow/queryByPage',dataObject).then(data=>{
          var seller=JSON.stringify(data);
          ////console.log('结果:'+seller);
          _this.ourServiceList=data.list;
          _this.totalPages=data.pages;
