    ...
    <div class="main-right">
          ...
          <div class="user-title">正尚科技后台管理平台</div>
              ...
              <el-table-column prop="id" label="ID"> </el-table-column>
							<el-table-column prop="name" label="新闻分组"> </el-table-column>
...
<script type='ecmascript-6'>
  ...
  import addOurService from './newsClass/addOurService';
  import changeOurService from './newsClass/changeOurService';
  import user from './user.vue';
    ...
    mounted (){
      ...
      _this.$get('/background-newsGroupName/queryByPage',pageData).then(data=>{
    ...
    methods: {
      deleteFun(row){
        ...
        _this.$confirm('是否要删除', '是否继续?', '提示', {
          ...
          type: 'warning'
        	...
        	_this.$get('/background-newsGroupName/delete',{id:row.id}).then(data=>{
        		var seller=JSON.stringify(data);
        		_this.$message({
        			type: 'success',
        			message: data+'!'
      ...
      changeSwitch (row) {
        ...
        var _this=this;
          ...
          type: 'warning'
					...
					_this.$get('/background-newsGroupName/updateUse',dataStr).then(data=>{
						var seller=JSON.stringify(data);
						//console.log('结果:'+seller);
      ...
      pageAxios(page){
        ...
        _this.$get('/background-news/queryByPage',dataObject).then(data=>{
          var seller=JSON.stringify(data);
          ////console.log('结果:'+seller);
          _this.ourServiceList=data.list;
          _this.totalPages=data.pages;
