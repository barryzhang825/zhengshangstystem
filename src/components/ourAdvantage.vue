  ...
  <div class="main">
    ...
    <div class="main-right">
          ...
          <div class="user-title">正尚科技后台管理平台</div>
              ...
              <el-table-column prop="title" label="我们的优势标题"> </el-table-column>
...
<script type='ecmascript-6'>
  ...
  import addOurService from './ourAdvantage/addOurService';
  import changeOurService from './ourAdvantage/changeOurService';
